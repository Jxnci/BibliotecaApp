<template>
  <section class="text-gray-800">
    <div class="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
      <div class="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-50 text-gray-800">
        <div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-blue-600">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="h-9 w-9 text-gray-100">
            <polygon
        ...
        <div class="flex flex-col justify-center align-middle">
          <p class="text-3xl font-semibold leadi">37</p>
          <p class="capitalize">Clientes</p>
        </div>
      </div>
      <div class="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-50 text-gray-800">
        <div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-blue-600">
        ...
        <div class="flex flex-col justify-center align-middle">
          <p class="text-3xl font-semibold leadi">164</p>
          <p class="capitalize">Nuevos usuarios</p>
        </div>
      </div>
      <div class="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-50 text-gray-800">
        <div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-blue-600">
        ...
        <div class="flex flex-col justify-center align-middle">
          <p class="text-3xl font-semibold leadi">+37%</p>
          <p class="capitalize">Crecimiento</p>
        </div>
      </div>
      <div class="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-50 text-gray-800">
        <div class="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-blue-600">
        ...
        <div class="flex flex-col justify-center align-middle">
          ...
          <p class="capitalize">Interacciones</p>
        </div>
      </div>
    </div>
  </section>
